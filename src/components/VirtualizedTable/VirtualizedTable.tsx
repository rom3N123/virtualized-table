...
import { VirtualizedTableProps, TableImperativeHandle } from './VirtualizedTable.types';
import { useSticky } from 'react-table-sticky';

function VirtualizedTable<D extends object = {}, ExtraItemProps extends object = {}>({
    tableRef,
    data,
    columns,
    getRowId,
