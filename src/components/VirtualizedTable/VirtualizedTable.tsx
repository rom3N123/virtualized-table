...
import { FinalTableInstance, useBlockLayout, useExpanded, useTable } from 'react-table';
...
import { VirtualizedTableProps, TableImperativeHandle, VIRTUALIZED_TABLE_PLUGINS } from '.';
import { useSticky } from 'react-table-sticky';

const VirtualizedTable = <D extends object = {}, ExtraItemProps extends object = {}>({
    tableRef,
    data,
    columns,
    getRowId,
