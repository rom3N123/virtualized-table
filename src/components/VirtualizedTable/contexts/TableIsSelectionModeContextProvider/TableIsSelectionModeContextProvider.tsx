...
export const TableIsSelectionModeContext = createContext<TableSelectionModeContextValue>({
    isSelectionMode: false,
    setIsSelectionMode: () => {},
});

const TableIsSelectionModeContextProvider: FC<{ children: ReactNode }> = ({ children }) => {
