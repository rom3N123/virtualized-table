...
export type TableRowsSelectionUseInstanceProps<D extends object> = TableSelectionModeInstanceProps &
    UseRowsRefsReturn<D> & { preselectedRows: D[] };

export type TableRowsSelectionInstance<D extends object> = TableInstanceWithProps<
    D,
    TableRowsSelectionUseInstanceProps<D>
>;

export const useInstance = <D extends object>(instance: TableRowsSelectionInstance<D>) => {
    const {
        rows,
        refs,
        getRowRef,
