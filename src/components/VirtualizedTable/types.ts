...
import { Column, GetRowId, PluginHook, Row, FinalTableInstance } from 'react-table';
import {
...
export type VirtualizedTableProps<D extends object = {}, ExtraItemProps extends object = {}> = {
    data: D[];
    columns: Column<D>[];
    getRowId: GetRowId<D>;
...
export type RenderItemPropsWithRef<D extends object = {}, E extends object = {}> = RenderItemProps<
    D,
    E
> &
    RowRefProp<D>;
